...
const en = {
  ...
  bar: {
    allDone: 'All uploads are complete',
    ...
    preparing: 'Preparing {{num}} file(s)',
    preparingButton: 'Preparing {{num}}',
    unreadable: '{{num}} unreadable file(s)',
    cancel: 'Cancel',
    uploading: 'Uploading',
  ...
  result: {
    ...
    partialTitle: 'Upload finished with some failures',
    summary: '{{success}} succeeded · {{failed}} failed',
    blocked: '{{num}} cannot be uploaded',
    hint: 'Successful uploads are waiting for admin review. You can stay here to upload another batch or view them on your profile.',
    retry: 'Retry {{num}} failed',
    newBatch: 'Upload another batch',
  ...
  toast: {
    ...
    waitForPreparation: 'Please wait while the selected files are prepared',
    noUploadableFiles: 'There are no files ready to upload',
...
const zhCN: typeof en = {
  ...
  bar: {
    ...
    preparing: '正在准备 {{num}} 个文件',
    preparingButton: '正在准备 {{num}} 个',
    unreadable: '{{num}} 个文件无法读取',
    cancel: '取消',
    uploading: '上传中',
    retryFailed: '重试失败项',
    done: '完成',
  ...
  result: {
    successTitle: '本次上传完成',
    partialTitle: '本次上传已结束，部分文件未上传',
    summary: '成功 {{success}} 个 · 失败 {{failed}} 个',
    blocked: '{{num}} 个不可上传',
    hint: '上传成功的内容正在等待管理员审核。你可以留在这里继续上传，也可以前往个人主页查看。',
    retry: '重试 {{num}} 个失败项',
    newBatch: '继续上传新一批',
    viewUploads: '查看我的上传',
  },
  toast: {
    ...
    waitForPreparation: '正在准备所选文件，请稍候',
    noUploadableFiles: '当前没有准备好可上传的文件',
...
const zhTW: typeof en = {
  ...
  bar: {
    ...
    preparing: '正在準備 {{num}} 個檔案',
    preparingButton: '正在準備 {{num}} 個',
    unreadable: '{{num}} 個檔案無法讀取',
    cancel: '取消',
    uploading: '上傳中',
    retryFailed: '重試失敗項',
    done: '完成',
  ...
  result: {
    successTitle: '本次上傳完成',
    partialTitle: '本次上傳已結束，部分檔案未上傳',
    summary: '成功 {{success}} 個 · 失敗 {{failed}} 個',
    blocked: '{{num}} 個不可上傳',
    hint: '上傳成功的內容正在等待管理員審核。你可以留在這裡繼續上傳，也可以前往個人主頁查看。',
    retry: '重試 {{num}} 個失敗項目',
    newBatch: '繼續上傳新一批',
    viewUploads: '查看我的上傳',
  },
  toast: {
    ...
    waitForPreparation: '正在準備所選檔案，請稍候',
    noUploadableFiles: '目前沒有準備好可上傳的檔案',
...
const ja: typeof en = {
  ...
  result: {
    ...
    partialTitle: 'アップロードが終了しました。一部は未送信です',
    summary: '成功 {{success}} 件 · 失敗 {{failed}} 件',
    blocked: '{{num}} 件はアップロードできません',
    hint: '成功したアップロードは管理者の審査待ちです。このまま次のファイルをアップロードするか、プロフィールで確認できます。',
    retry: '失敗した {{num}} 件を再試行',
    newBatch: '次のファイルをアップロード',
    viewUploads: '自分のアップロードを見る',
  },
  toast: {
    ...
    waitForPreparation: '選択したファイルを準備しています。しばらくお待ちください',
    noUploadableFiles: 'アップロードできるファイルがありません',
