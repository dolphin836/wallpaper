          ...
          <div key={platform}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {items.map((v) => (
                <div
                  key={v.id}
                  className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg"
                >
                  <div>
    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div
            className="w-full flex items-center justify-center bg-gray-100 relative group"
            ...
            <div className="flex items-center justify-between gap-4 mb-6">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button
                  ...
                  title={matchedVariant ? `Preview for ${matchedVariant.brand} ${matchedVariant.device_name}` : 'No matching resolution for your device'}
