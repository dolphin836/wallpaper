...
enum L10n {
    ...
    private static let zhHans = AppStrings(
        ...
        privacyTitle: "隐私政策",
        dmcaTitle: "版权 / DMCA",
        legalBodyNote: "法律正文会跟随你的语言设置显示；如有差异，以英文版本为准。",
        lastUpdated: "最后更新",
        legalVersion: "版本",
        about: "关于",
        appVersion: "当前版本",
    ...
    private static let zhHant = AppStrings(
        ...
        privacyTitle: "隱私政策",
        dmcaTitle: "版權 / DMCA",
        legalBodyNote: "法律正文會跟隨你的語言設定顯示；如有差異，以英文版本為準。",
        lastUpdated: "最後更新",
        legalVersion: "版本",
        about: "關於",
        appVersion: "目前版本",
    ...
    private static let ja = AppStrings(
        ...
        dmcaTitle: "著作権 / DMCA",
        legalBodyNote: "法的本文は言語設定に合わせて表示されます。差異がある場合は英語版が優先されます。",
        lastUpdated: "最終更新",
        legalVersion: "バージョン",
        about: "このアプリについて",
        appVersion: "現在のバージョン",
    ...
    private static let en = AppStrings(
        ...
        legalBodyNote: "The legal body text follows your language setting. If translations differ, the English version controls.",
