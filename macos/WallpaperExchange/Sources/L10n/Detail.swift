...
struct DetailStrings {
    ...
    let wallpaperLockScreenDetail: String
    ...
    let lockScreenAerialDownloadRequired: String
    let lockScreenPermissionRequired: String
    let lockScreenImageUnavailable: String
    let lockScreenConversionUnavailable: String
    let lockScreenConversionFailed: String
    let lockScreenScreenSaverFailed: String
...
private let detailEN = DetailStrings(
    ...
    wallpaperChooseDisplay: "Choose target",
    ...
    wallpaperLockScreenDetail: "macOS 26 · Apple Aerial",
    ...
    lockScreenScreenSaverFailed: "Failed to configure Apple Aerial as the lock screen screen saver.",
    lockScreenReloadFailed: "macOS did not keep the animated lock screen selection. Choose All Displays and try again.",
...
private let detailZhCN = DetailStrings(
    ...
    wallpaperLockScreenDetail: "macOS 26 · Apple 航拍",
    wallpaperApply: "应用",
    ...
    lockScreenScreenSaverFailed: "无法将锁屏屏幕保护程序配置为 Apple 航拍。",
    lockScreenReloadFailed: "macOS 未保留动态锁屏配置，请选择“全部显示器”后重试。",
...
private let detailZhTW = DetailStrings(
    ...
    wallpaperLockScreenDetail: "macOS 26 · Apple 空拍",
    wallpaperApply: "套用",
    ...
    lockScreenScreenSaverFailed: "無法將鎖定畫面螢幕保護程式設定為 Apple 空拍。",
    lockScreenReloadFailed: "macOS 未保留動態鎖定畫面設定，請選擇「所有顯示器」後再試。",
...
private let detailJA = DetailStrings(
    ...
    lockScreenScreenSaverFailed: "ロック画面のスクリーンセーバを Apple Aerial に設定できませんでした。",
    lockScreenReloadFailed: "macOS が動画ロック画面の設定を保持できませんでした。「すべてのディスプレイ」を選んで再試行してください。",
