...
private let homeEN = HomeStrings(
    ...
    archiveIntro: "We publish ten wallpapers each ISO week. Once a piece lands in a drop it never returns. Browse the rack and pick an issue.",
...
private let homeZhCN = HomeStrings(
    ...
    archiveIntro: "我们每个 ISO 周发布十张壁纸。作品一旦入选某期便不再重复出现。往下翻，挑一期看看吧。",
...
private let homeZhTW = HomeStrings(
    ...
    archiveIntro: "我們每個 ISO 週發佈十張桌布。作品一旦入選某期便不再重複出現。往下捲動，挑一期看看吧。",
...
private let homeJA = HomeStrings(
    ...
    archiveIntro: "毎 ISO 週に10枚の壁紙を公開しています。一度ドロップに掲載された作品は二度と登場しません。下にスクロールして号を選んでください。",
