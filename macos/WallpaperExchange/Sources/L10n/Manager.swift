...
struct ManagerStrings {
    ...
    let noWallpapers: String
    let noDownloadsYet: String
    let noDownloadsHint: String
...
private let managerEN = ManagerStrings(
    ...
    noDownloadsHint: "Try a wallpaper from Latest. Open a wallpaper detail page to set it.",
...
private let managerZhCN = ManagerStrings(
    ...
    noDownloadsHint: "可以先从最新壁纸里选择一张，打开详情页后设置为壁纸。",
    loadingMore: "正在加载更多…",
    loadMore: "加载更多",
    end: "到底了",
...
private let managerZhTW = ManagerStrings(
    ...
    downloaded: "已下載",
    noWallpapers: "暫無桌布",
    noDownloadsYet: "還沒有下載",
    noDownloadsHint: "可以先從最新桌布裡選擇一張，開啟詳情頁後設定為桌布。",
    loadingMore: "正在載入更多…",
    loadMore: "載入更多",
    end: "到底了",
...
private let managerJA = ManagerStrings(
    ...
    latest: "最新",
    downloaded: "ダウンロード済み",
    noWallpapers: "壁紙はありません",
    noDownloadsYet: "まだダウンロードがありません",
    noDownloadsHint: "最新から壁紙を選び、詳細ページで壁紙に設定できます。",
